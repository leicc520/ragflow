...
from rag.settings import database_logger, SVR_QUEUE_NAME, SVR_QUEUE_NAME_CRAWLER, SVR_CONSUMER_NAME, SVR_CONSUMER_GROUP_NAME
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] == "crawler": #根据参数启动消费不同的队列
